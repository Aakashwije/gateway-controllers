...
> **Prerequisite**: The MCP Authorization policy requires the [MCP Authentication policy](../../../mcp-auth/v1.3/docs/mcp-authentication.md) to be applied first. The MCP Authentication policy validates and extracts JWT claims that are used by the authorization policy for access control decisions.
...
- [MCP Authentication Policy](../../../mcp-auth/v1.3/docs/mcp-authentication.md) - Validates JWT tokens and is a prerequisite for MCP Authorization
