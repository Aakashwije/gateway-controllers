...
| [MCP Authentication](./mcp-auth/v1.3/docs/mcp-authentication.md) | MCP, Security | This policy is used to secure traffic to Model Context Protocol server as defined in the specification (https://modelcontextprotocol.io/specification/2025-06-18/basic/authorization). |
...
| [OpenAI to Mistral Transformer](./openai-to-mistral-transformer/v0.9/docs/openai-to-mistral-transformer.md) | AI, LLM Transformation | Adapts OpenAI Chat Completions requests for Mistral-compatible upstreams by pinning the model, stripping OpenAI fields Mistral rejects, and rewriting the request path. |
