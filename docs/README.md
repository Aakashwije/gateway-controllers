...
| [Cost-Based Model Routing](./cost-based-model-routing/v0.9/docs/cost-based-routing.md) | AI | Budgets exact, pattern-matched, and unlisted requested models, then uses the fallback model's own budget or rejects with HTTP 429 without looping. |
